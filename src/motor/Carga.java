...
public class Carga {
      public Atos[] carga(Atos[] c){
        Atos a = new Atos(0 , "Pois bem, então parte em sua longa jornada.\n"
                ...
                + "1-Seguir dormindo   2- Acordar",2,3,0,0,0);
        c[0] = a;
...
"                + \"██████████████████████████████████████\"\n" +
"                + \n"
                 + "1-APAGAR VELA   2-IR AO BANHEIRO ", 4,5,0,0,0 );
        c[2]=d;
       /* Atos e =new Atos(3, "\n"
                        + "░▒░░▒░▒▒▒▒▒▒▒▒▒▒▒▒▓██▒▒▒▒▒▒▒▒▒▒▒▒░▒░▒▒\n"
                        + "░▒░▒▒▒▒▒▒▒▒▒▒▒▒▒▒░▓█▓▒▒▒▒▒▒▒▒▒▒▒▒▒░▒░▒\n"
        ...
        c[3]=e;
        Atos f= new Atos(4, jogador.getNome() + " vai até o lavabo atirar agua em sua face para dissipar a preguiça ainda remanescente, a agua está\n"
                ...
                + 1-Ir para a despensa   2-Caçar algo para comer", 5,6,0,0,0);
        c[4]=f;
